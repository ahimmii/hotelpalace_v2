...
$('#example2 tbody').on('click', '.vue', function() {
    ...
    // alert("See DATAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAaa")
    $('.insertHere').html(
        // Adding and structuring the full data
        '<table class="table table-striped table-responsive-sm modalShowTable" width="100%"><tbody><tr><td>First Name<td><td>' + data[1] + '</td></tr><tr><td>Last name<td><td>' + data[2] + '</td></tr><tr><td>Age<td><td>' + data[10]+" " +data[6] +'</td></tr><tr><td>Mobile No.<td><td>' + data[3] + '</td></tr><tr><td>Cin<td><td>' + data[4] + '</td></tr><tr><td>Status<td><td>' + data[12] + '</td></tr></tr><tr><td>Mutual Number<td><td>' + data[5] + '</td></tr><tr><td>Mutual Type<td><td>' + data[13] + '</td></tr><tr><td>Sex<td><td>' + data[8] + '</td></tr> <tr><td>Blood Group<td><td>' + data[9] + '</td></tbody></table>'
    );
...
//     // Your data headers
//     var headers = ['First Name', 'Last Name', 'Mobile No.', 'CIN', 'CNSS']; // Add or remove headers as needed

//     // Constructing the table dynamically
//     var tableHtml = '<table class="table table-striped table-responsive-sm modalShowTable" width="100%"><tbody>';

//     // Loop through headers and data
//     for (var i = 1; i < headers.length + 1; i++) {
//         tableHtml += '<tr><td>' + headers[i - 1] + '<td><td>' + data[i] + '</td></tr>';
//     }
